if not _G.KnownModIndex:IsModEnabledAny("workshop-2111412487") then return end -- 检查Lazy Controls是否开启
...
if _G.KnownModIndex:IsModEnabledAny("workshop-3136701076") then -- 检查黑化排队论是否开启
